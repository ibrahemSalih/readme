...
class poli_7_home extends StatefulWidget {
  poli_7_home({Key? key}) : super(key: key);

  @override
  State<poli_7_home> createState() => _poli_7_homeState();
}

class _poli_7_homeState extends State<poli_7_home> {
  @override
