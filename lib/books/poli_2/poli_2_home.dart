...
class poli_2_home extends StatefulWidget {
  poli_2_home({Key? key}) : super(key: key);

  @override
  State<poli_2_home> createState() => _poli_2_homeState();
}

class _poli_2_homeState extends State<poli_2_home> {
  @override
