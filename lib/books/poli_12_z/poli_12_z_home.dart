...
class poli_12_z_home extends StatefulWidget {
  poli_12_z_home({Key? key}) : super(key: key);

  @override
  State<poli_12_z_home> createState() => _poli_12_z_homeState();
}

class _poli_12_z_homeState extends State<poli_12_z_home> {
  @override
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              "پۆلی دوازدەیەمی دواناوەندی زانستی",
              style: TextStyle(
