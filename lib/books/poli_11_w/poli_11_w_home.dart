...
class poli_11_w_home extends StatefulWidget {
  poli_11_w_home({Key? key}) : super(key: key);

  @override
  State<poli_11_w_home> createState() => _poli_11_w_homeState();
}

class _poli_11_w_homeState extends State<poli_11_w_home> {
  @override
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              "پۆلی یازدەیەمی دواناوەندی وێژەیی",
              style: TextStyle(
