...
class poli_6_home extends StatefulWidget {
  poli_6_home({Key? key}) : super(key: key);

  @override
  State<poli_6_home> createState() => _poli_6_homeState();
}

class _poli_6_homeState extends State<poli_6_home> {
  @override
