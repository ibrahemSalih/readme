...
class poli_11_z_home extends StatefulWidget {
  poli_11_z_home({Key? key}) : super(key: key);

  @override
  State<poli_11_z_home> createState() => _poli_11_z_homeState();
}

class _poli_11_z_homeState extends State<poli_11_z_home> {
  @override
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              "پۆلی یازدەیەمی دوناوەندی زانستی",
              style: TextStyle(
