...
class poli_10_w_home extends StatefulWidget {
  poli_10_w_home({Key? key}) : super(key: key);

  @override
  State<poli_10_w_home> createState() => _poli_10_w_homeState();
}

class _poli_10_w_homeState extends State<poli_10_w_home> {
  @override
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              "پۆلی دەیەمی دوا ناوەندی وێژەیی",
              style: TextStyle(
